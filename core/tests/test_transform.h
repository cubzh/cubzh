...
void test_transform_rotation_position(void) {
    ...
    {
        Transform *p = transform_new(HierarchyTransform);
        Transform *c = transform_new(HierarchyTransform);
...
void test_transform_children(void) {
    Transform *p = transform_new(HierarchyTransform);
    Transform *c1 = transform_new(HierarchyTransform);
    Transform *c2 = transform_new(HierarchyTransform);
