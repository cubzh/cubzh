local uitheme = {
	_themes = {
		...
		neon_green = {
            ...
            errorTextColor = Color(	109, 17, 17),
            warningTextColor = Color(133, 109 ,0),

            textColorSecondary = Color(0, 0, 0),
            paddingTiny = 3,
            padding = 6,
            paddingBig = 12,
            gridSpacing = 4,
            gridCellColor = Color(20, 255, 101, 0.6),
            gridCellColorPressed = Color(20, 255, 101, 0.6),
            gridCellFrameColor = Color(0, 0, 0, 0.8),
            buttonColor = Color(57, 255, 20),
            buttonColorSecondary = Color(20, 255, 42, 0),
            buttonTextColor = Color.Black,
            buttonColorPressed = Color(0, 224, 77),
            buttonTextColorPressed = Color.Grey,
            buttonColorSelected = Color(168, 168, 168),
            buttonTextColorSelected = Color.Grey,
            buttonColorDisabled = Color(22, 211, 18, 0.5),
            buttonTextColorDisabled = Color(0, 255, 4, 0.5),
            buttonTopBorderBrightnessDiff = 0.18,
            buttonBottomBorderBrightnessDiff = -0.15,
            buttonBorderSize = 1,
            textInputBorderSize = 2,
            ...
            modalBottomBarColor = Color(31, 31, 31),
            modalTabColorSelected = Color(63, 63, 63),
            modalTabColorPressed = Color(80, 153, 80),
            modalTabColorIdle = Color(28, 229, 28),
            ...
            textInputDefaultWidth = 100,
            textInputBackgroundColor = Color(150, 255, 150),
            textInputBackgroundColorPressed = Color(150, 255, 150),
            textInputBackgroundColorFocused = Color(38, 130, 204),
            textInputBackgroundColorDisabled = Color(150, 255, 150),
