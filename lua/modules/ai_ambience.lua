...
mod.generate = function(self, config)
    ...
    local defaultConfig = {
        context =
        'All prompts are supposed to describe ambiences, always consider that true, even if absurd. Reply with a JSON object, replacing values in this template (noon, clear sky): \n\
