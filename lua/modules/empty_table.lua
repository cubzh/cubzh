...
local function printMessageOnFirstAccess(t)
	if t.__accessed == false then			if t.__messageType == "log" then
			print(t.__message)
...
local mt = {
	...
	__index = function(t) printMessageOnFirstAccess(t) return t end,
	__newindex = function(t) printMessageOnFirstAccess(t) end,
	...
	__metatable = function() return false end,
}
